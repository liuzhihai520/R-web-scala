...
/**
 * Created by 24950 on 2015/11/23.
 * HH
 * 加密解密
 */
public class DeEnCode {
    //前端用户登录cookie加密密匙
    public static String KEY = "RUIJIUTOU!@!@$";

    private static final DeEnCode instance = new DeEnCode();

    private DeEnCode() {

    }

    public static DeEnCode getInstance() {
        return instance;
    }
    ...
    public static void main(String[] args)  {
        DeEnCode crypt = DeEnCode.getInstance();
        String content = "testName";
        System.out.println(crypt.encryptAES(content, KEY));
        String dcontent = crypt.encryptAES(content,KEY);
        System.out.println(crypt.decryptAES(dcontent,KEY));
    }
}